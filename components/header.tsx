...
// import { Lightbulb, Heart, ShoppingCart } from 'lucide-react';

// const Header: React.FC = () => {
//   return (
//     <header className="bg-white shadow-md">
//       <div className="container mx-auto px-4 py-6 md:flex flex-row  items-center justify-between">
//         {/* Logo */}
//         <div className="flex items-center space-x-2">
//           <img src="/logo.png" alt="Logo" className="h-8 w-8" />
//           <span className="text-lg font-bold text-gray-800">weframetech</span>
//         </div>
...
//             className="w-full  border border-gray-300 p-2 text-gray-700 focus:outline-none focus:ring focus:ring-blue-300"
//           />
//         </div>

//         {/* Icons */}
//         <div className="flex items-center space-x-4">
//           <a href="#" className="text-gray-600 hover:text-gray-800 flex">
//           <Lightbulb />Inspirations
//           </a>
//           <a href="#" className="relative text-gray-600 hover:text-gray-800">
//             <span className='flex space-x-1'>
//                 <Heart />
//                 <span>Mes favoris</span>
//                 <span className="bg-gray-300 px-2 items-center flex text-black text-xs rounded-full">24</span> 
//              </span>
            
//           </a>
//           <button className="bg-blue-500 text-white px-4 py-2 rounded-lg flex space-x-2">
//             <ShoppingCart />
//             <span>Panier</span>
//           </button>
//         </div>
...
import { Lightbulb, Heart, ShoppingCart, Menu, X } from 'lucide-react';
      ...
      <div className="container mx-auto px-4 py-6 flex items-center justify-between">
        ...
        <div className=" items-center justify-center space-x-2 flex-row space-y-2">
          <span className='flex items-center justify-center'>
            <Image height={100} width={100} src="/logo1.png" alt="logo1" className='h-7 w-11 '></Image>
          </span>
          <Image height={100} width={100} src="/logo2.png" alt="Logo" className="h-3" />
        ...
        {/* Icons */}
        <div className="flex items-center space-x-4">
          <a href="#" className="text-gray-600 hover:text-gray-800 hidden md:flex">
            <Lightbulb />
            Inspirations
          </a>
          <a href="#" className="relative text-gray-600 hover:text-gray-800 hidden md:flex">
            <span className="flex space-x-1">
              <Heart />
              <span>Mes favoris</span>
